...
const SearchBar: React.FC<SearchBarProps> = ({
  ...
  return (
    <>
      ...
      <div
        className="w-full mb-3 md:mb-6 px-6 py-6 md:py-8 rounded-3xl border border-white/70 bg-white shadow-[0_18px_45px_-30px_rgba(15,23,42,0.4)] backdrop-blur-lg transition-all"
        // style={{
        //   background:
