  ...
  return (
    <div className="bg-white text-gray-900 pt-16 sm:pt-16"> {/* Added responsive padding-top to account for fixed/sticky navbar height (assuming ~64px/5rem on small, ~80px on larger; adjust values based on actual navbar height) */}
      ...
      >
        ...
        {/* Content */}
        <div className="relative z-10 h-full mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center text-center">
      ...
      <section aria-labelledby="vp-title" className="bg-white">
        <div className="mx-auto max-w-screen-lg px-4 sm:px-6 lg:px-8 text-center py-10 md:py-14">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-12 md:pb-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="relative">
              ...
              <div className="pointer-events-none absolute -bottom-6 -right-6 w-32 h-32 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full blur-2xl opacity-30" />
            </div>

            {/* Reasons */}
            <div>
              <div className="inline-flex items-center bg-gradient-to-r from-indigo-500 to-purple-600 text-white px-4 py-1 font-semibold rounded-full mb-5">
            ...
            {[
              ...
              >
                <header className="flex items-center mb-5">
                  <div
                    className={`w-14 h-14 rounded-full bg-gradient-to-r ${t.color} flex items-center justify-center text-white font-bold text-lg mr-4`}
                    aria-hidden
                  >
                    {t.initials}
                  </div>
      ...
      <section aria-label="Primary call to action" className="bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
          <div className="relative rounded-3xl overflow-hidden p-8 md:p-12 bg-gradient-to-br from-indigo-600 to-purple-700 shadow-2xl text-center">
            {/* floating elems */}
            <div className="absolute top-0 left-0 w-40 h-40 rounded-full bg-gradient-to-r from-cyan-400/20 to-blue-500/20 blur-3xl" />
            <div className="absolute bottom-0 right-0 w-40 h-40 rounded-full bg-gradient-to-r from-pink-400/20 to-rose-500/20 blur-3xl" />
