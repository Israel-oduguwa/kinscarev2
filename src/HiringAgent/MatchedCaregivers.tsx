...
const BASE_URL = "http://localhost:8081/api/v1/providers/jumpstart/all-matches";
const INTERVIEW_URL =
  "http://localhost:8081/api/v1/providers/jumpstart/interview-caregiver";
const INTERVIEWED_URL =
  "http://localhost:8081/api/v1/providers/jumpstart/interview-caregivers"; // GET
 ...
 const {userData} = useAuthContext();
  ...
  const handleAddToInterview = async (caregiver: any) => {
    ...
    try {
      ...
      const res = await privateApi.post(INTERVIEW_URL, payload);
