...
//     `https://kinscare-backend.onrender.com/api/v1/forum/threads?page=${page}&limit=${limit}`
//   );
...
async function getThreads(queryParams: {
  ...
  const url = `https://kinscare-backend.onrender.com/api/v1/forum/threads?page=${page}&limit=10${
