...
function ForumDynamicNavbar() {
 ...
 <>
  {userData?.role === "caregiver" ? (
    ...
    <header>
      <nav className="bg-white/80 z-50 backdrop-blur-md fixed top-0 w-full border-b border-gray-200 shadow-sm px-4 lg:px-6 py-3 transition-all duration-300 dark:bg-gray-800/80">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-2xl">
          {/* Logo */}
          <Link className="flex items-center" href="/">
            <img
