...
// If you have a custom Label component in your setup (e.g. @/components/ui/label), you can import it.
// Otherwise, a standard <label> can also work.
...
interface MultiSelectProps
  ...
  /** A label that is shown above the multiselect */
  label?: string;
  options: {
    label: string;
    value: string;
