        ...
        {isFetchingSecret ? (
          ...
          <>
            ...
            <Button
              ...
              className="w-full mt-4 px-6 py-3 text-sm bg-[hsl(var(--accent))] text-[hsl(var(--accent-foreground))] rounded-lg shadow hover:bg-[hsl(var(--accent))] hover:shadow-lg transition"
            >
              Use another card
            </Button>
          </>
