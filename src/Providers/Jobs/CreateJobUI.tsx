...
function CreateJobUI({ jobID, userData, job, type }: any) {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      if (type === "repost") {
        ...
        // console.log(payload);
        await privateApi.post("/api/v1/providers/post-job", payload);
        const tagManagerArgs = {
          dataLayer: {
            event: `post_job`,
            type: "post",
  ...
  const savetoDB = debounce(async (formData: any) => {
    if (type !== "repost") {
      try {
        const save = await privateApi.post(
          "/api/v1/providers/post-job",
          formData
        );
        // console.log(save);
          ...
          <div>
            ...
            <div className="flex flex-col space-y-6">
              <div className="flex flex-col space-y-3">
                ...
                <div className="w-full prose-lg prose-h3:my-2 prose-blockquote:my-2  discussion-content max-w-full">
                    ...
                    render={({ field }) => (
                      <label className="flex items-center space-x-3">
                        ...
                        <span className="text-sm text-gray-700">
                          ...
                          respond to your application. By continuing, you agree
                          to receive job alerts from Kinscare. Message & data
