...
export default function WelcomeDialog() {
  ...
  }, [customData?.complete]); // Run this effect whenever `customData.complete` changes

  // If `customData.complete` is false, don't render the Dialog at all
  if (customData?.complete) return null;
