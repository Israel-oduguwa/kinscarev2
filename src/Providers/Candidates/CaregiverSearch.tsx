  ...
  return (
    <div className="bg-gradient-to-r from-blue-600 to-blue-900 text-white rounded-lg shadow-md p-4 md:p-6">
      <div className="max-w-6xl mx-auto">
        <div className="mb-4">
          <h1 className="text-lg md:text-xl font-bold tracking-tight">Search Caregivers</h1>
          <p className="text-gray-200 text-xs md:text-sm mt-1">
            Browse through professional caregivers available for your requirements. Use the filters below to refine your search.
          </p>
        </div>
        <div className="mb-1">
          <div className="w-full p-4 md:p-6 bg-white rounded-lg shadow-sm">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              ...
              <Button
                ...
                onClick={() => {onSearchClick(); !loading && setIsOpen(false)}}
                disabled={loading}
              >
...
export default function CaregiverSearch() {
  ...
  return (
    ...
    <PopoverTrigger asChild>
      <button
        className="group relative z-50 flex items-center w-full max-w-sm px-4 py-3 bg-white/80 backdrop-blur-sm border border-gray-200 rounded-full shadow-sm hover:border-blue-400 focus:outline-none transition-all duration-300 ease-out hover:shadow-md"
      >
