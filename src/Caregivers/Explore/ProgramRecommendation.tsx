...
const ProgramRecommendation: React.FC = () => {
  const { user }: any = useContext(MongoContext);
  ...
  useEffect(() => {
    ...
    if ((!urls || urls.length === 0) && user?.customData?.recommendations) {
      ...
      if (collegePrograms && Array.isArray(collegePrograms) && collegePrograms.length > 0) {
    ...
    const selectedUrls = pickRandomUrls(urls, 3);
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[300px] p-6">
        <div className="bg-red-50 p-4 rounded-xl max-w-md w-full border border-red-100">
          ...
          <div className="text-red-600 text-lg font-semibold text-center mb-2">Something went wrong</div>
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px]">
        <div className="mb-8">
          ...
          <h2 className="text-xl font-bold text-center mt-6 text-gray-800">Finding the best programs for you</h2>
        </div>
        {renderProgress()}
      </div>
    );
  ...
  return (
    <div className="max-w-5xl mx-auto p-4">
      <div className="text-center mb-10">
        ...
        <p className="text-gray-600 mt-2">Curated just for you based on your preferences</p>
      </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                {program.data.location && (
                  <div className="flex items-center bg-gray-100 text-gray-700 px-3 py-1.5 rounded-lg text-sm">
                    <svg className="w-4 h-4 mr-1.5 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              {(program.data.contact_name || program.data.contact_email || program.data.contact_phone) && (
