        ...
        <div className="py-8 mx-6 px-4 md:px-10 rounded-lg shadow-lg bg-white">
          <div>
            <div className="mb-5">
              ...
              Help connect caregivers with the best opportunities while earning up to $55 for your referrals             
               </p>
               <p className="text-sm antialiased">
               Know of a job opening at your workplace or in your community? Post the details here to help others grow their careers. You’ll earn up to $ 55.00 and gift the employer 7 days of free access to Kinscare, where they can connect directly with top applicants!
               </p>
            </div>
