            ...
            {[
              {
                ...
                description:
                  "Make a one-time payment of $200. No subscriptions, no hidden fees.",
                icon: (
                  <svg
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-8 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/jumpstart-hiring/apply">
              ...
              >
                <span className="relative z-10">Book Now – $200</span>
          ...
          >
            {[
              ...
              },
              {
                ...
                answer:
                  "Just click 'Book Now,' pay the $200 fee, and complete the intake form. Your KinsCare agent will reach out to confirm your needs.",
              },
            ].map((item, index) => (
              <motion.div
                key={index}
