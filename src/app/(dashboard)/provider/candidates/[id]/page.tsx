...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      description: `Discover ${caregiver.fname} ${caregiver.lname}, a caregiver with expertise in ${caregiver.licenses.join(", ")}. Available in ${caregiver.city}.`,
      images: [
        {
    ...
    twitter: {
      ...
      title: `Caregiver: ${caregiver.fname} ${caregiver.lname}`,
      description: `Learn more about ${caregiver.fname} ${caregiver.lname}, a professional caregiver in ${caregiver.city}.`,
...
// Page Component
async function page({ params: rawParams }: { params: Promise<{ id: string }> }) {
