...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Update your provider account profile. Keep your account details up-to-date and ensure your information is accurate for better visibility and opportunities.",
    url: "https://kinscare.org/providers/profile/update", // Replace with your page URL
    type: "website",
    images: [
      {
        url: "https://kinscare.org/images/update-profile-og-image.jpg", // Replace with a relevant image URL
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [
      "https://kinscare.org/images/update-profile-twitter-image.jpg", // Replace with a relevant image URL
    ],
  },
};
