...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://kinscare.org/provider/job", // Replace with the dynamic URL
    type: "website",
    images: [
      {
        url: "https://kinscare.org/assets/images/job-detail-og.jpg", // Replace with an appropriate image URL
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://kinscare.org/assets/images/job-detail-twitter.jpg"], // Replace with a Twitter-optimized image URL
  },
};
