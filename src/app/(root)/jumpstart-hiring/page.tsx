...
const jsonLd = {
  ...
  description:
    "A premium caregiver matchmaking service by KinsCare. Pay $200 and a KinsCare agent will find and schedule interviews with 3 qualified caregivers in 3 days, plus 2 weeks of unlimited platform access.",
  provider: {
    "@type": "Organization",
    name: "KinsCare",
